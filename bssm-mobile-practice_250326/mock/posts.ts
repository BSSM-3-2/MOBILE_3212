...
const MOCK_POSTS: Post[] = [
    ...
    },
    {
        ...
        images: [{ type: 'LOCAL', source: macbookImage }],
        likes: 421,
        caption: '코딩하다가 찍은 셋업 📸 역시 카페가 최고야 #개발자일상',
        timestamp: '2일 전',
        comments: [],
    },
    {
        ...
        images: [{ type: 'LOCAL', source: yorushika }],
        likes: 1587,
        caption: '다시 듣는 요루시카. 비 오는 날엔 이게 맞지 🌧️ #요루시카 #플레이리스트',
        timestamp: '3일 전',
        comments: [],
    },
    {
        ...
        images: [{ type: 'LOCAL', source: cat }],
        likes: 1923,
        caption: '오늘도 만났다 우리 동네 냥이 🐱 이제 도망 안 가요',
        timestamp: '3일 전',
        comments: [],
    },
    {
        ...
        images: [{ type: 'LOCAL', source: chicken }],
        likes: 567,
        caption: '야식은 역시 치킨이지 🍗🍺 오늘은 양념으로 갔습니다',
        timestamp: '4일 전',
        comments: [],
    },
    {
        ...
        images: [{ type: 'LOCAL', source: renecite }],
        likes: 983,
        caption: '밤에 보는 괘법르네시떼역은 또 다른 느낌이다 🌃',
        timestamp: '4일 전',
        comments: [],
    },
    {
        ...
        images: [{ type: 'LOCAL', source: ba }],
        likes: 2745,
        caption: '3주년 기념 일러스트 너무 좋다 😭 #블루아카이브 #3주년',
        timestamp: '5일 전',
        comments: [],
    },
    {
    ...
    },
    {
        ...
        images: [{ type: 'LOCAL', source: cat }],
        likes: 2201,
        caption: '냥이가 무릎에 올라왔다 🐾 오늘 운수 좋은 날',
        timestamp: '6일 전',
        comments: [],
    },
    {
    ...
    },
    {
        id: '19',
        userId: '04a7e261-f0b3-4d98-8c15-6e23d9a07b52',
        images: [{ type: 'LOCAL', source: ba21 }],
        likes: 3890,
        caption: '요시미 아크릴 스탠드 도착 📦 #블아굿즈',
        timestamp: '8일 전',
        comments: [],
    },
    {
        id: '20',
        userId: 'a3f1c2d4-11b0-4e8a-9f23-bc4501d6e780',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post20/600/600' }],
        likes: 1204,
        caption: '어디론가 떠나고 싶은 날 🏔️ #여행스타그램 #자연',
        timestamp: '1일 전',
        comments: [],
    },
    {
    ...
    },
    {
        id: '25',
        userId: 'a3f1c2d4-11b0-4e8a-9f23-bc4501d6e780',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post25/600/600' }],
        likes: 1891,
        caption: '안개 낀 산길 걷기 🌫️ #등산 #힐링',
        timestamp: '6일 전',
        comments: [],
    },
];
